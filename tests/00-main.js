...
module.exports.vendors = require("../models/game/vendors");
// JSON data
...
module.exports.deathsJSON = require("../models/game/data/deaths.json");
// localization data
module.exports.localization = require("../models/game/data/localization/index");
